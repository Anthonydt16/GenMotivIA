    ...
    def requestOpenIA(self)-> str:
        ...
        self.reponse = openai.ChatCompletion.create(
            ...
            messages= [
                ...
                {"role": "user", "content": "maintenant fais moi une lettre de motivation qui explique mon parcours et pourquoi je veux ce poste et que j'ai les compétences pour ce poste mais n'invente pad de compétences que je n'ai pas. c'est hyper important"},
            ])
